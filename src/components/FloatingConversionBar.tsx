 ...
 * Mobile-first sticky conversion bar — WhatsApp + Request Quote.
 */
...
export default function FloatingConversionBar({
  ...
  return (
    <>
      {/* Mobile bottom bar */}
      <div
        className="fixed bottom-0 inset-x-0 z-40 md:hidden border-t border-soft-border bg-brand-card/95 backdrop-blur-md px-3 py-2.5 safe-area-pb"
      ...
      >
        <div className="flex gap-2 max-w-lg mx-auto">
          <button
            type="button"
            onClick={onOpenQuote}
            className="flex-1 min-h-[44px] px-3 py-2 bg-gold-base hover:bg-gold-dark text-text-charcoal font-mono text-[10px] font-bold uppercase tracking-wider rounded flex items-center justify-center gap-1.5"
          >
            <FileText size={14} />
          ...
          <a
            ...
            className="flex-1 min-h-[44px] px-3 py-2 bg-emerald-600 hover:bg-emerald-500 text-white font-mono text-[10px] font-bold uppercase tracking-wider rounded flex items-center justify-center gap-1.5"

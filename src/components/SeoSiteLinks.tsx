...
const SITE_LINKS: { href: string; labelEn: string; labelAr: string }[] = [
  ...
  { href: "/silver-bars-iraq", labelEn: "Silver Bars Iraq", labelAr: "سبائك الفضة العراق" },
  { href: "/sam-palm-silver-iraq", labelEn: "SAM & PALM Silver Iraq", labelAr: "فضة SAM وPALM العراق" },
  { href: "/gold-bars-baghdad", labelEn: "Gold Bars Baghdad", labelAr: "سبائك الذهب بغداد" },
  { href: "/silver-bars-erbil", labelEn: "Silver Bars Erbil", labelAr: "سبائك الفضة أربيل" },
  { href: "/bullion-desk-iraq", labelEn: "Bullion Desk Iraq", labelAr: "مكتب السبائك العراق" },
